...
const StatusTag = styled(Tag)<{ status: string }>`
  ${props => {
    switch (props.status) {
      case 'scheduled':
        return 'background-color: #e6f7ff; color: #1890ff; border-color: #91d5ff;';
      case 'in-progress':
        return 'background-color: #fff7e6; color: #fa8c16; border-color: #ffd591;';
      case 'completed':
        return 'background-color: #f6ffed; color: #52c41a; border-color: #b7eb8f;';
      case 'cancelled':
        return 'background-color: #fff2f0; color: #ff4d4f; border-color: #ffb3b3;';
      default:
        return '';
    }
  }}
